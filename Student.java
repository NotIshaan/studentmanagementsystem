	...
	public Student() {
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "INSERT INTO `studentmanagementsystem`(`studentname`, `entrynumber`, `email`, `contactnumber`, `homecity`) VALUES (?, ?, ?, ?, ?)";
					con = DriverManager.getConnection("jdbc:mysql://localhost:3306/studentdata", "root", "ishaan");
					...
					else if(sentry.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "Entry Number not entered");
					}
					else if(semail.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "Email ID not entered");
					}
					else if(scontact.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "Contact Number not entered");
					}
					else if(shome.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "Home City not entered");
					}
					else {	
						pst.executeUpdate();
