...
public class Login extends JFrame {
	...
	public Login() {
		...
		loginUsername.setFont(new Font("JetBrainsMono-Regular", Font.BOLD, 14));
		
		JLabel loginPassword = new JLabel("Password");
		loginPassword.setForeground(Color.BLACK);
		loginPassword.setFont(new Font("JetBrainsMono-Regular", Font.BOLD, 14));
		...
		login.setFont(new Font("JetBrainsMono-Regular", Font.BOLD, 14));
		...
		loginpage.setFont(new Font("JetBrainsMono-Regular", Font.BOLD, 22));
